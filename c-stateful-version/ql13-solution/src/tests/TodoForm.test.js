...
describe(`TodoForm test suite`, () => {
    ...
    describe('Fopr submission test', () => {
        test('it should call submitTodo with a prescribed parameters on submision', async () => {
            ...
            await act(async () => {
                completedInput.props.onChange({
                    target: {
                        checked: compTestValue
                    }});
            });

            await act(async () => {
                descInput.props.onChange({
                    target: {
                        value: descTestValue
                    }
                })
